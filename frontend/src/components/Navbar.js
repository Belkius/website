  ...
  return (
    <>
        ...
        <nav>
          ...
          <div className="hidden md:flex p-4 border border-none rounded-lg bg-transparent text-sm text-white font-medium" id="navbar-pc">
            <NavLink exact to="/" onClick={handleLinkClick} className={`px-3 py-2 ${activeLink === '/' ? 'bg-[#22d3ee]' : 'hover:text-[#22d3ee]'}`}>
              Projects
            </NavLink>
            <NavLink exact to="/skills" onClick={handleLinkClick} className={`px-3 py-2 ${activeLink === '/skills' ? 'bg-[#c4344f]' : 'hover:text-[#c4344f]'}`}>
              Skillset
            </NavLink>
            <NavLink to="/about" onClick={handleLinkClick} className={`px-3 py-2 ${activeLink === '/about' ? 'bg-[#22d3ee]' : 'hover:text-[#22d3ee]'}`}>
              About me
            </NavLink>
            <NavLink to="/contact" onClick={handleLinkClick} className={`px-3 py-2 ${activeLink === '/contact' ? 'bg-[#c4344f]' : 'hover:text-[#c4344f]'}`}>
              Contact
            </NavLink>
          </div>
          ...
          <div className={`${menu ? 'block' : 'hidden'} md:hidden w-auto px-6 py-1 no-underline text-left text-xl font-semibold`}>
              ...
              <a href="/contact" className="block px-10 py-2 hover:border-2 text-[#22d3ee]">Contact</a>
          </div>
        </nav>
