  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 place-items-center justify-between gap-4 mx-10 my-4">
        <button className="h-16 w-16 md:h-32 md:w-32 py-2 px-2 rounded-md text-white font-medium bg-[#22d3ee]"
        onClick={() => setMultiplier(1)}>x1</button>
        <button className="h-16 w-16 md:h-32 md:w-32 py-2 px-2 rounded-md text-white font-medium bg-[#22d3ee]"
        onClick={() => setMultiplier(2)}>x2</button>
        <button className="h-16 w-16 md:h-32 md:w-32 py-2 px-2 rounded-md text-white font-medium bg-[#22d3ee]"
        onClick={() => setMultiplier(3)}>x3</button>
        <button className="h-16 w-16 md:h-32 md:w-32 py-2 px-2 rounded-md text-white font-medium bg-[#C4344F]"
        onClick={() => {}}>undo</button>
      </div>
      ...
      <div className="grid grid-cols-5 place-items-center justify-evenly md:grid-cols-6 lg:grid-cols-9 gap-4 mx-10">
        {points.map((button) => (
          <button
            key={button.label}
            className={`h-16 w-16 md:h-32 md:w-32 py-2 px-2 rounded-md text-white font-medium ${button.color}`}
      ...
      <div className="py-12 grid grid-cols-2 place-items-center justify-between lg:grid-cols-4 gap-x-2 gap-y-4">
          ...
          </div> <div className="h-24 w-48 relative bg-[#1A1A1A]">
            <div className="font-primary text-white group-hover:text-[#C4344F] text-2xl pt-4 px-4 font-semibold">
              Player name
              Score: {score}
            </div>
